...
from tf.keras.layers import Convolution2D, MaxPooling2D, Flatten, Dense
...
model.fit(tr_dataset, steps_per_epoch=int(4000/32), epochs=100, validation_data=ts_dataset,
